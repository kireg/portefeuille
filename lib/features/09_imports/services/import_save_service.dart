...
class ImportSaveService {
  ...
  static Future<int> saveSelected({
    ...
    if (newCandidates.isNotEmpty) {
      ...
      final Map<String, List<String>> depositAssetsByDate = {}; // Pour les notes détaillées
      
      for (final candidate in newCandidates) {
        final parsed = candidate.parsed;
        
        // Créer la transaction (id borné en taille via UUID)
        ...
        // Sans compensation, les liquidités seraient artificiellement négatives.
        // Exemple : Import d'un compte avec 3 achats pour -8500€ → Sans compensation : -8500€
        ...
        if (parsed.type == TransactionType.Buy || parsed.type == TransactionType.Withdrawal) {
          ...
          // Collecter les actifs pour la note détaillée
          ...
          depositAssetsByDate[dateKey]!.add(
            '$typeLabel: ${parsed.assetName} ${parsed.quantity.toStringAsFixed(2)}@${parsed.price.toStringAsFixed(2)}€'
          );
        }
      }
