...
import 'package:portefeuille/features/07_management/services/csv_import_service.dart';
...
import 'package:portefeuille/features/07_management/ui/widgets/csv_import/csv_header.dart';
import 'package:portefeuille/features/07_management/ui/widgets/csv_import/csv_file_picker.dart';
  ...
  Future<void> _validateImport() async {
    ...
    for (final parsed in _extractedTransactions) {
      final transaction = Transaction(
        ...
        type: parsed.type,
        date: parsed.date,
        assetTicker: parsed.ticker ?? parsed.isin ?? parsed.assetName,
        ...
        amount: (parsed.type == TransactionType.Buy || parsed.type == TransactionType.Withdrawal)
            ...
            : parsed.amount.abs(),
        fees: parsed.fees,
        notes: "Import CSV: $_fileName",
        assetType: parsed.assetType ?? AssetType.Stock,
      ...
      if (parsed.type == TransactionType.Buy) {
         final depositTransaction = Transaction(
          ...
          quantity: null,
          price: null,
          amount: parsed.amount + parsed.fees,
          fees: 0,
