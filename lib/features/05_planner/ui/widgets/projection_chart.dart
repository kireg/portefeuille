        ...
        touchTooltipData: BarTouchTooltipData(
          ...
          getTooltipItem: (group, groupIndex, rod, rodIndex) {
            ...
            return BarTooltipItem(
              'Année ${d.year}\n',
              AppTypography.bodyBold.copyWith(fontSize: 14),
              children: [
                // Ligne 1 : Montant Investi
                TextSpan(
                  text: 'Investi: ${CurrencyFormatter.format(investedAmount, baseCurrency)}\n',
                ...
                TextSpan(
                  ...
                  style: AppTypography.bodyBold.copyWith(
                      ...
                      fontSize: 13,
                      height: 1.8 // Un peu d'espace avant le total
                  ),
                ),
              ],
            );
